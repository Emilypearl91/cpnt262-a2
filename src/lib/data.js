...
export let cornLettuce = {
  ...
  URL: 'src/lib/assets/amy-syiek-4irgyik6Q3U-unsplash.jpg'
};
export let shrimpBowl = {
  ...
  URL: 'src/lib/assets/ryan-concepcion-w_z0RJCSBiE-unsplash.jpg'
};
...
export let edamameSalmon = {
  ...
  URL: 'src/lib/assets/anh-nguyen-kcA-c3f_3FE-unsplash.jpg' 
};
...
export let bestsellers = {
  ...
  sesameURL: 'src/lib/assets/food-photographer-FtpgFeUQuAY-unsplash.jpg',
  ...
  radishURL: 'src/lib/assets/sina-piryae-bBzjWthTqb8-unsplash.jpg',
  chickenTitle: 'Chicken Rice Bowl',
  chickenInfo: 'This chicken rice bowl is made with corn, rice, tomatoes and grilled chicken.',
  chickenURL: 'src/lib/assets/food-photographer-zhkhwGrqilw-unsplash.jpg'
};
